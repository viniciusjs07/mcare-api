...
const professional = require('./routes/professiona.routes');
...
module.exports = mongoose.connect( process.env.MONGODB_URI, {useNewUrlParser: true, useCreateIndex: true}, async (err) => {
